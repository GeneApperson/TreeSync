...
void	CopyMem(int cb, BYTE * pvDst, const BYTE * pvSrc);
...
int		CchOfSz(const char * sz);
int		IchOfCh(char * sz, char ch);
char *	PchOfCh(char * sz, char ch);
bool	FIsNulSz(const char * sz);
char *	SzCopy(char * szDst, const char * szSrc);
char *	SzAppend(char * szDst, const char * szSrc);
char *	SzEnd(char * sz);
char *	SzReplaceCh(char * sz, char chOld, char chNew);
WCHAR *	WszFromSz(WCHAR * wsz, char * sz);
char *	SzFromWsz(char * sz, WCHAR * wsz);
int		CompareSz(const char * szA, const char * szB);
int		CompareSzI(const char * szA, const char * szB);
